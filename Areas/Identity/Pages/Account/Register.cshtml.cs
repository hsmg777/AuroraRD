...
namespace AuroraRD.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required]
            [StringLength(100,ErrorMessage =("Maximo caracteres alcanzado"))]
            [Display(Name = "Nombre")]
            public string Name { get; set; }
            [Required]
            [StringLength(100, ErrorMessage = ("Maximo caracteres alcanzado, cumpla el formato de 10 max"))]
